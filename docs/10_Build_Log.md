...
### 43.7 The Cloudflare zone — one change made, six handed over
...
- **Crawler Hints was stopped at the toggle.** Enabling it is an agreement, not a switch: the card says doing so accepts Cloudflare's Supplemental Terms and shares site information with crawlers. The founder approved a toggle, not terms nobody had read. Also founder-side.
