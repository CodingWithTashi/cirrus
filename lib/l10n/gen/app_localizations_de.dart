...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String obCoachNameAsk(String name) {
    return 'Wir nennen es $name. Es hört auf jeden Namen — nimm den, den du um 2 Uhr nachts wirklich tippen würdest.';
  }
  ...
  String get obWhyWordsHintHealth =>
      'damit ich auf der Treppe nicht mehr klinge wie ein Wasserkocher';

  @override
  String get obWhyWordsHintMoney =>
      'Ich will mein Geld zurück. Und meine Morgen.';

  @override
  String get obWhyWordsHintFreedom =>
      'weil ich den 23-Uhr-Gang zur Tankstelle satt habe';

  @override
  String get obWhyWordsHintFamily =>
      'mein Kind hat es in meiner Jacke gefunden. Nie wieder.';
  ...
  String get obWhyWordsHintAppearance =>
      'ich will die ausgeschlafene Version meines Gesichts zurück';
  ...
  @override
  String get paywallFeatPanic => 'Alle drei Panik-Spiele, nicht nur Orbs';

  @override
  String get paywallFeatPlan =>
      'Ein Plan, der sich anpasst, wenn du rückfällig wirst';

  @override
  String get paywallFeatForecasts =>
      'Verlangens-Prognosen für deine Risikostunden';

  @override
  String get paywallFeatCommunity =>
      'Eine Community, die auf dein SOS antwortet';
  ...
  @override
  String get paywallCta => 'Meine Gratiswoche starten';
  ...
  @override
  String get paywallTimelineTodayBody => 'Alles freigeschaltet';

  @override
  String get paywallTimelineRemindBody => 'Wir erinnern dich';

  @override
  String get paywallTimelineNoRemindBody =>
      'Letzter Tag, um kostenlos zu kündigen';

  @override
  String paywallTimelineChargeBody(String price) {
    return 'Erste Abbuchung: $price. Vorher kündigen, nichts zahlen.';
  }
  ...
  String paywallDisclosureTrial(
    ...
    return '$price pro $period nach deiner $days-tägigen Gratis-Testphase. Verlängert sich automatisch, bis du kündigst — jederzeit kündbar in den Abo-Einstellungen von $store.';
  }

  @override
  String paywallDisclosure(String price, String period, String store) {
    return '$price pro $period. Verlängert sich automatisch, bis du kündigst — jederzeit kündbar in den Abo-Einstellungen von $store.';
  }
  ...
  String paywallYearlySubLive(String perWeek, int percent) {
    return '$perWeek/Woche · SPARE $percent%';
  }

  @override
  String paywallYearlySubPerWeek(String perWeek) {
    return '$perWeek/Woche';
  }
  ...
  String paywallCtaTrial(int days) {
    String _temp0 = intl.Intl.pluralLogic(
      days,
      locale: localeName,
      other: 'Meine $days Gratis-Tage starten',
      one: 'Meinen Gratis-Tag starten',
    );
    return '$_temp0';
  }

  @override
  String get paywallCtaSubscribe => 'Premium starten';
  ...
  String paywallSubtitleTrial(int days) {
    String _temp0 = intl.Intl.pluralLogic(
      days,
      locale: localeName,
      other: 'Teste alles $days Tage lang kostenlos.',
      one: 'Teste alles einen Tag lang kostenlos.',
    );
    return '$_temp0';
  }

  @override
  String get paywallSubtitleNoTrial => 'Alles freigeschaltet, ab heute.';

  @override
  String get paywallRestore => 'Käufe wiederherstellen';

  @override
  String get paywallRestored => 'Willkommen zurück — Premium ist aktiv.';

  @override
  String get paywallRestoreNothing =>
      'In diesem Store-Konto gibt es noch nichts wiederherzustellen.';

  @override
  String get paywallPurchasePending =>
      'Deine Zahlung ist ausstehend. Premium wird aktiv, sobald der Store sie bestätigt.';

  @override
  String get paywallPricesUnavailable =>
      'Live-Preise laden gerade nicht — der Store zeigt dir den genauen Preis vor der Bestätigung.';

  @override
  String get premiumWelcomeEyebrow => 'Premium freigeschaltet';

  @override
  String get premiumWelcomeTitle => 'Du bist drin.';
  ...
  String premiumWelcomeTrialBody(int days) {
    ...
    return '$_temp0 mit allem, auf uns.';
  }

  @override
  String get premiumWelcomeBody =>
      'Alles hier unten gehört dir, ab dieser Sekunde.';

  @override
  String get premiumWelcomeUnlocks => 'Was gerade freigeschaltet wurde';

  @override
  String premiumWelcomeCharge(String date) {
    return 'Erste Abbuchung am $date.';
  }

  @override
  String get premiumWelcomeReminder => 'Wir erinnern dich am Tag davor.';

  @override
  String get premiumWelcomeCta => 'Los geht\'s';

  @override
  String get premiumWelcomeCtaDay1 => 'Meinen Tag 1 einrichten';

  @override
  String get premiumLockTitle => 'Premium';

  @override
  String get premiumLockCta => 'Premium ansehen';

  @override
  String get premiumPitchInsight =>
      'Dein Wochenbericht, geschrieben aus deinen eigenen Zahlen.';
  ...
  @override
  String get freeCompareLog => 'Zug-Protokoll + Serien';

  @override
  String get freeCompareMoney => 'Sparzähler';

  @override
  String get freeCompareCoach => 'Coach-Nachrichten';

  @override
  String get freeCompareGames => 'Panik-Spiele';

  @override
  String get freeComparePosts => 'Community-Posts';

  @override
  String get freeCompareHistory => 'Statistik-Verlauf';

  @override
  String get freeCompareHealth => 'Gesundheits-Zeitstrahl';

  @override
  String get freeComparePlan => 'Plan passt sich nächtlich an';

  @override
  String get freeCompareForecast => 'Craving-Prognosen';
  ...
  @override
  String get freeCompareForever => 'Alles';

  @override
  String get freeCompareAll => 'Alle';
  ...
  String freePlanProCta(int days) {
    String _temp0 = intl.Intl.pluralLogic(
      days,
      locale: localeName,
      other: 'Pro $days Tage gratis testen',
      one: 'Pro einen Tag gratis testen',
    );
    return '$_temp0';
  }

  @override
  String get freePlanTitle => 'Du bist auf Free.';

  @override
  String get freePlanSubtitle =>
      'Für immer deins. Kein Countdown, kein Nerven.';

  @override
  String get freePlanUpgradeNote =>
      'Jederzeit upgraden — Serie und Verlauf kommen mit.';

  @override
  String get freePlanCta => 'Mit Free starten';
  ...
  String get day1TourHoursBody =>
      'Wähl die Stunde, in der es dich meistens erwischt. Wir melden uns zehn Minuten vorher, auf deinem Handy, ohne dass du fragst.';
  ...
  @override
  String get savingsInfoLabel => 'So wird das Ersparte berechnet';

  @override
  String get savingsInfoTitle => 'So kommt dein Erspartes zusammen';

  @override
  String get savingsInfoUsualDay => 'Dein üblicher Tag';
  ...
  @override
  String get savingsInfoToday => 'Heute';

  @override
  String get savingsInfoTodayNotCounted => 'Zählt noch nicht';
  ...
  String savingsInfoTodayValue(num puffs, String saved) {
    ...
    return '$_temp0 · $saved gespart';
  }

  @override
  String get savingsInfoTotal => 'Bisher gespart';

  @override
  String get savingsInfoWhyNotCounted =>
      'Heute zählt ab deinem ersten eingetragenen Zug — oder sobald du einen dampffreien Tag bestätigst. Bis dahin kommt nichts dazu.';
  ...
  String savingsInfoWhyKept(int usual, String perPuff, num notTaken) {
    ...
    return 'Jeder Zug unter deinen üblichen $usual spart etwa $perPuff. Heute: $_temp0 weniger.';
  }
  ...
  String savingsInfoWhyKeptPerTen(int usual, String perTen, num notTaken) {
    ...
    return 'Je 10 Züge unter deinen üblichen $usual sparen etwa $perTen. Heute: $_temp0 weniger.';
  }

  @override
  String savingsInfoWhyNothingKept(int usual) {
    return 'Heute liegst du bei oder über deinen üblichen $usual Zügen, also kommt nichts dazu. Morgen geht\'s frisch los.';
  }

  @override
  String get savingsInfoWhyUnpriced =>
      'Dein Plan hat keine wöchentlichen Ausgaben, also gibt es noch nichts zu zählen.';
  ...
  @override
  String get panicBreatheInstruction => 'Atme mit dem Kreis.';

  @override
  String get panicBreatheIn => 'Einatmen';

  @override
  String get panicBreatheHold => 'Halten';

  @override
  String get panicBreatheOut => 'Ausatmen';
  ...
  String gameLockedTitle(String game) {
    return '$game ist ein Premium-Spiel.';
  }

  @override
  String gameLockedBody(String game) {
    return '$game gehört dir gratis, für immer — und funktioniert genauso gut.';
  }
  ...
  String get splashJourneyUnavailableTitle =>
      'Deine Reise lässt sich gerade nicht laden';

  @override
  String get splashJourneyUnavailableBody =>
      'Du bist weiterhin angemeldet und nichts ist verloren. Prüf deine Verbindung und versuch es nochmal.';
  ...
  String get errorPurchaseNotAllowedTitle =>
      'Käufe sind auf diesem Gerät deaktiviert';

  @override
  String get errorPurchaseNotAllowedBody =>
      'Dieses Gerät oder Konto kann gerade keine Abos kaufen — meist wegen Kindersicherung oder einer Store-Einschränkung. Es wurde nichts abgebucht.';

  @override
  String get errorStoreTitle => 'Der Store hat nicht geantwortet';

  @override
  String get errorStoreBody =>
      'Google Play oder der App Store hatte einen Aussetzer. Es wurde nichts abgebucht — versuch es in einer Minute noch mal.';

  @override
  String get errorReceiptOwnedTitle =>
      'Dieses Abo gehört zu einem anderen Konto';

  @override
  String get errorReceiptOwnedBody =>
      'Das Abo dieses Store-Kontos ist mit einer anderen Cirrus-Anmeldung verknüpft. Melde dich dort an oder stelle es von diesem Konto aus wieder her.';
  ...
  @override
  String get statsDayNoPuffs => 'Heute keine Züge eingetragen';
  ...
  String statsHardDayNoRecovery(String day) {
    return '$day war der schwere Tag.';
  }

  @override
  String statsHardDayNoRecoveryReason(String day, String reason) {
    return '$day war der schwere Tag — $reason.';
  }

  @override
  String get statsHardDayToday =>
      'Bisher ist heute der Tag mit den meisten Zügen.';

  @override
  String statsHardDayTodayReason(String reason) {
    return 'Bisher ist heute der Tag mit den meisten Zügen — $reason.';
  }
  ...
  @override
  String get statsNicotineDown => 'Niedriger als der vorige volle Tag';

  @override
  String get statsNicotineUp => 'Höher als der vorige volle Tag';
  ...
  String get communityRuleSlur =>
      'Das kann nicht gepostet werden – Beleidigungen und Hass haben hier keinen Platz.';
  ...
  String get communityTooShort =>
      'Ein paar Worte mehr — genug, damit dir jemand wirklich helfen kann.';

  @override
  String get communityTooRepetitive =>
      'Sag es mit deinen eigenen Worten — das bekommt Antworten.';

  @override
  String get communitySosStillUp =>
      'Dein SOS steht noch oben im Feed. Die Leute sehen es.';
  ...
  @override
  String get communityStatusPosting => 'Wird gepostet …';

  @override
  String get communityStatusFailed => 'Nicht gesendet – tippen zum Wiederholen';
  ...
  @override
  String get healthAnchorNone => 'Noch kein Zug geloggt';
  ...
  @override
  String get settingsSubscriptionYearly => 'Premium · jährlich';

  @override
  String get settingsSubscriptionMonthly => 'Premium · monatlich';

  @override
  String get settingsSubscriptionWeekly => 'Premium · wöchentlich';
  ...
  String settingsSubscriptionTrial(String date) {
    return 'Testphase · endet am $date';
  }
  ...
  String get settingsManageUnavailable =>
      'Verwalte dieses Abo über das Store-Konto, mit dem es gekauft wurde.';
  ...
  @override
  String get settingsDangerHoursTitle => 'Wann ist das Verlangen am stärksten?';

  @override
  String get settingsDangerHoursNote =>
      'Wähl die Stunde, in der es meistens losgeht. Wir stupsen dich 10 Minuten vorher – ein Push am Tag, mehr nicht.';

  @override
  String settingsDangerHoursNudge(String time) {
    return 'Ein Stups gegen $time, jeden Tag.';
  }

  @override
  String get settingsDangerHoursNotifOff =>
      'Benachrichtigungen sind aus – es kommt nichts, bis du sie einschaltest.';

  @override
  String settingsQuietHours(String range) {
    return 'Nie zwischen $range – Ruhezeit.';
  }
  ...
  String get settingsQuietHoursHint =>
      'Zieh an den Enden. Nichts, was wir senden, landet darin.';
  ...
  @override
  String get settingsQuietHoursStartHandle => 'Beginn der Ruhezeiten';

  @override
  String get settingsQuietHoursEndHandle => 'Ende der Ruhezeiten';
  ...
  @override
  String get trialEndingStatsLabel => 'DEINE WOCHE BISHER';
  ...
  @override
  String get trialEndingKeep => 'Premium behalten';
  ...
  String trialEndsOn(String date) {
    return 'Deine Testphase endet am $date.';
  }
  ...
  @override
  String get widgetDayFreedom => 'Freiheitstag 🏆';

  @override
  String get widgetDayPastOne => '%1\$d Tag nach dem Freiheitstag';

  @override
  String get widgetDayPastOther => '%1\$d Tage nach dem Freiheitstag';
  ...
  @override
  String get widgetWatchOpenPhone => 'Öffne Cirrus auf deinem iPhone';
