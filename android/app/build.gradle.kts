...
// Release signing lives in android/key.properties (gitignored); machines
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.quitvape.last_puff"
