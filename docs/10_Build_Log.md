...
## 29. COMMUNITY PUSH (Sep 6) — the notification nobody could have tapped
...
### 29.1 The bug under the feature
...
### 29.2 Grouping, and where each half lives
...
### 29.3 Quiet hours are a channel, not a flag
...
### 29.4 Mentions over identifiers that do not identify
...
### 29.5 A preference the server never heard
...
### 29.6 The blank screen behind the deep link
...
### 29.8 The inbox, and what the emulator caught (Sep 6, same day)
...
### 29.9 The emulator pass — three states, real taps
...
### 29.10 The status-bar icon, and the emoji standing in for icons
